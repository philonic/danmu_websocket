...
!function (a) {
    a.fn.barrager = function (b) {
        ...
        b = a.extend({
            ...
            href: b.href,
            id: b.id
        }).empty().append(b.info), navigator.userAgent.indexOf("MSIE 6.0") > 0 || navigator.userAgent.indexOf("MSIE 7.0") > 0 || navigator.userAgent.indexOf("MSIE 8.0") > 0 ? j.css("color", b.old_ie_color) : j.css("color", b.color),
            k = 0,
            f.css("margin-right", k),
            l = setInterval(m, b.speed), div_barrager_box.mouseover(function () {
            clearInterval(l)
